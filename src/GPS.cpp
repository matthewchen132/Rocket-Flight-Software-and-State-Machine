...
double GPS::convertAbsolute(double latitude, double longitude, double altitude){
  
  double x = cos(longitude*PI/180);
  double y = sin(latitude*PI/180);
